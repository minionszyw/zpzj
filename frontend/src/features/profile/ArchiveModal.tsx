...
import { BaziTimePicker } from './BaziTimePicker';
...
// 获取当前时间的 naive ISO 字符串
const getNowNaiveISO = () => {
    const now = new Date();
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <BaziTimePicker 
                        ...
                        onChange={(val) => setFormData({ ...formData, birth_time: val })} 
                    />
                  </div>
